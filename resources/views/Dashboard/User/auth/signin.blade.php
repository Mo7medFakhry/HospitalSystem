                                    ...
                                    <div class="card-sigin">
                                        ...
                                        <div class="card-sigin">
                                            <div class="main-signup-header">
                                                ...
                                                <label for="exampleFormControlSelectLg">Select method Login </label> <br>
                                                <select class="form-select form-select-lg mb-3"
                                                    id="exampleFormControlSelectLg">
                                                    <option selected>Choose From This Menu</option>
...
@section('js')
    <script>
        $('#exampleFormControlSelectLg').on('change', function () {
            var myID = $(this).val();
